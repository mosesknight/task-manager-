...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
