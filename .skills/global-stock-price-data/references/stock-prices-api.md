...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote`
...
async function getStockPrices(
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote?${query.toString()}`,
