...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/{uuid}`
...
async function getSimilarNews(uuid: string, params: SimilarNewsParams = {}): Promise<SimilarNewsResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-m9xKXDbR1oka.gateway.appmedo.com/v1/news/similar/${encodeURIComponent(uuid)}${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
