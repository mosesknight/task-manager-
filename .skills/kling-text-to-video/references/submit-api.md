...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-bu4nt8w3c3k1-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| HTTP Method | `POST` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-bu4nt8w3c3k1-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video",
    {
      method: "POST",
      headers: {
