...
- **Endpoint**: `GET/POST https://app-bu4nt8w3c3k1-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article`
...
async function callWebpageContentExtract(
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-Q9KWZ8R7Qv09.gateway.appmedo.com/v3/article?${params.toString()}`,
    {
