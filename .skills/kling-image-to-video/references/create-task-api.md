...
| Property | Value |
|----------|-------|
| **Endpoint** | `POST https://app-bu4nt8w3c3k1-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video` |
...
async function submitImage2VideoTask(params: {
  ...
  const response = await fetch(
    "https://app-bu4nt8w3c3k1-api-eLMlJj3KJD89.gateway.appmedo.com/v1/videos/image2video",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
