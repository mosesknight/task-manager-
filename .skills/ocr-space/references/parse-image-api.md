...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-bu4nt8w3c3k1-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image` |
...
async function ocrParseImage(params: {
  ...
  const response = await fetch("https://app-bu4nt8w3c3k1-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-bu4nt8w3c3k1-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
