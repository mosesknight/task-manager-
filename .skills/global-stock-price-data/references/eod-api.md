...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod`
...
async function getEodData(symbol: string, params: EodParams = {}): Promise<EodResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-V9gDze3qV2PL.gateway.appmedo.com/v1/data/eod?${query.toString()}`,
