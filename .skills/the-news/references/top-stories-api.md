...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top`
...
async function getTopStories(params: TopStoriesParams = {}): Promise<TopStoriesResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
