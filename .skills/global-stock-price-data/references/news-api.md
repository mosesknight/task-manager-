...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all`
...
async function getFinanceNews(params: NewsParams = {}): Promise<NewsResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-AalZze1qEWML.gateway.appmedo.com/v1/news/all?${query.toString()}`,
