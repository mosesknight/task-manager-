...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all`
...
async function getAllNews(params: AllNewsParams = {}): Promise<AllNewsResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-W9z3M6eOKQVL.gateway.appmedo.com/v1/news/all${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
