...
| Item | Details |
|------|---------|
| Endpoint | `POST https://app-bu4nt8w3c3k1-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2` |
...
async function translateText(params: TranslateParams): Promise<TranslationResult[]> {
  const response = await fetch(
    "https://app-bu4nt8w3c3k1-api-GaDwZ8DX7jPY.gateway.appmedo.com/language/translate/v2",
    {
      method: "POST",
      headers: {
