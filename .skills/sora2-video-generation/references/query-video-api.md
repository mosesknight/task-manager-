...
| Item | Details |
|------|---------|
| Endpoint | `POST https://api-DYJwnoM46d6a@app-bu4nt8w3c3k1-api-DYJwnoM46d6a.gateway.appmedo.com` |
...
async function queryVideoStatus(videoId: string): Promise<VideoStatusResponse> {
  const response = await fetch(
    "https://api-DYJwnoM46d6a@app-bu4nt8w3c3k1-api-DYJwnoM46d6a.gateway.appmedo.com",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
