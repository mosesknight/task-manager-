...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-bu4nt8w3c3k1-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl` |
...
async function ocrParseImageUrl(
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-m9xKXDbRplNa.gateway.appmedo.com/parse/imageurl?${params.toString()}`,
    {
      method: "GET",
      headers: {
