...
**Endpoint:** `POST https://app-bu4nt8w3c3k1-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image`
...
async function submitOmniImageTask(params: SubmitParams): Promise<SubmitResult> {
  ...
  const response = await fetch(
    "https://app-bu4nt8w3c3k1-api-2Y00Vzbe0MBY.gateway.appmedo.com/v1/images/omni-image",
    {
      method: "POST",
      headers: {
