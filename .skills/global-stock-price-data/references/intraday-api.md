...
**Endpoint:** `GET https://app-bu4nt8w3c3k1-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday`
...
async function getIntradayData(symbol: string, params: IntradayParams = {}): Promise<IntradayResponse> {
  ...
  const response = await fetch(
    `https://app-bu4nt8w3c3k1-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday?${query.toString()}`,
